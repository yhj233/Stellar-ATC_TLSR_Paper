...
### 按照自己喜好修改了样式时钟模式1为日历 目前支持M3N特别批次和原项目不支持的新版Stellar-M.  型号需要在epd.c里自行修改FORCE后面的数字

> 我的Stellar-M批次为101915 (为这块屏修改了LUT!)屏幕型号： <br>
...
Stellar-M其他批次有DEPT的屏幕 主控可能为UC8251 有AI CODING的代码但是我没有屏就禁用了
